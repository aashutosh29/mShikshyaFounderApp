...
*/
     ...
     */
    public Model getEnglishDate(@IntRange(from = 2070, to = 2080) int nepYY,
        ...
        if (isNepDateInConversionRange(nepYY, nepMM, nepDD)) {
            ...
            int startingDayOfWeek = Calendar.SUNDAY; // 2060/1/1 is Wednesday
     ...
     * @return {@link Model } object with the converted value from nepali to english
     */
    public List<CDayItem> getEnglishLightly(@IntRange(from = 2070, to = 2080) int nepYY,
                                            @IntRange(from = 1, to = 12) int nepMM,
                                            @IntRange(from = 1, to = 32) int nepDD) {
     ...
     */
    public Model getNepaliDate(@IntRange(from = 2013 - 2023) int engYY,
        ...
        if (isEngDateInConversionRange(engYY, engMM, engDD)) {
            ...
            int startingDayOfWeek = Calendar.TUESDAY; // 1944/1/1 is Saturday

            int startingNepYear = 2069;
    ...
    private static boolean isEngDateInConversionRange(int yy, int mm, int dd) {
        return (yy >= 2013 && yy <= 2023) && (mm >= 1 && mm <= 12) && (dd >= 1 && dd <= 31);
    }
    ...
    private static boolean isNepDateInConversionRange(int yy, int mm, int dd) {
        return (yy >= 2070 && yy <= 2080) && (mm >= 1 && mm <= 12) && (dd >= 1 && dd <= 32);
    }
     ...
     */
    public int getFirstWeekDayMonth(@IntRange(from = 2070, to = 2080) int yy, @IntRange(from = 1, to = 12) int mm) {
     ...
     */
    public int noOfDaysInMonth(@IntRange(from = 2070, to = 2080) int yy, @IntRange(from = 1, to = 12) int mm) {
     ...
     */
    public int getWeekDay(@IntRange(from = 2070, to = 2080) int yy, @IntRange(from = 1, to = 12) int mm, @IntRange(from = 1, to = 32) int dd) {
