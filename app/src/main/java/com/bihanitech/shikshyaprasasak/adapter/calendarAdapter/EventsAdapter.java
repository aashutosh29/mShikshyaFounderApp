...
public class EventsAdapter extends RecyclerView.Adapter<EventsAdapter.HolidaysViewHolder> {

    private final List<Event> examRoutineItemList;

    public EventsAdapter(List<Event> examRoutineItemList) {
